...
*/
package modelEditor.distortions.spell.engine;
...
public class PropertyConfiguration extends Configuration {
  ...
  /**
   * @see modelEditor.distortions.spell.engine.Configuration#getBoolean(String)
   */
  ...
  /**
   * @see modelEditor.distortions.spell.engine.Configuration#getInteger(String)
   */
  ...
  /**
   * @see modelEditor.distortions.spell.engine.Configuration#setBoolean(String, boolean)
   */
  ...
  /**
   * @see modelEditor.distortions.spell.engine.Configuration#setInteger(String, int)
   */
