...
*/
package modelEditor.distortions.spell.swing.autospell;
...
import modelEditor.distortions.spell.engine.Configuration;
import modelEditor.distortions.spell.event.DocumentWordTokenizer;
import modelEditor.distortions.spell.event.SpellChecker;

import modelEditor.distortions.spell.event.*;
import modelEditor.distortions.spell.engine.*;
		...
		if (pos >= 0) {
			...
			if(attr.containsAttribute(wordMisspelled, wordMisspelledTrue)){
				...
				for(int i=0;i<suggestions.size();i++) {
					modelEditor.distortions.spell.engine.Word w = (modelEditor.distortions.spell.engine.Word) suggestions.get(i);
